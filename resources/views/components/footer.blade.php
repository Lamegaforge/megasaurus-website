<footer class="p-4 bg-slate-800">
    <div class="container mx-auto flex flex-col items-center lg:flex-row">
      ...
      <ul class="flex space-x-4 order-first lg:order-1 lg:ml-auto">
          ...
          <li>
            <a class="footer-link text-white" target="_blank" rel="noopener noreferrer" href="https://www.youtube.com/user/lamegaforge">
          ...
          <li>
            <a class="footer-link text-white" target="_blank" rel="noopener noreferrer" href="https://www.facebook.com/LaMegaforge/">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 512 512">
          ...
          <li>
            <a class="footer-link text-white" target="_blank" rel="noopener noreferrer" href="https://twitter.com/LaMegaforge">
              <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 512 512">
          ...
          <li>
            <a class="footer-link text-white" target="_blank" rel="noopener noreferrer" href="https://www.instagram.com/lamegaforge/">
